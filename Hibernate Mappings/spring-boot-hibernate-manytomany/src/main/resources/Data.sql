...
values(1,'Spring Boot JPA', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
insert into course(id, name, created_date, last_updated_date) 
values(2,'Spring Boot AWS Utilites', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
insert into course(id, name, created_date, last_updated_date) 
values(3,'Spring Boot PCF Cloud Deployment', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
